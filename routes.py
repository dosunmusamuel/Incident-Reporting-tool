...
from resources.dashboard import DashboardResource,IncidentSearchResource,ReportsResource,ExportReportsExcelResource
...
def register_routes(app):
    ...
    api.add_resource(ExportReportsExcelResource, "/api/export")
